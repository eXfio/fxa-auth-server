  ...
  var routes = [
    {
      ...
      handler: function accountCreate(request, reply) {
        ...
        function checkAnonymousAccount () {
           return isAnonymousAccount(form.email)
            .then(
              function (result) {
                anonymousAccount = result;
              }
            )
        }
        ...
        function createAccount () {
          ...
          return db.createAccount({
            ...
            emailVerified: form.preVerified || preVerified || anonymousAccount,
